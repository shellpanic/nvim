return {
   ...
   config = function()
      require("aerial").setup({
         ...
         autojump = false,
         icons = {},
         ignore = { unlisted_buffers = false, filetypes = {}, buftypes = "special", wintypes = "special" },
         manage_folds = false,
         link_folds_to_tree = false,
         link_tree_to_folds = true,
         nerd_font = "auto",
         on_attach = function() end,
         on_first_symbols = function() end,
         ...
         float = { border = "rounded", relative = "cursor", max_height = 0.9, height = nil, min_height = { 8, 0.1 } },
         nav = {
            border = "rounded",
            max_height = 0.9,
            min_height = { 10, 0.1 },
         ...
         lsp = { diagnostics_trigger_update = true, update_when_errors = true, update_delay = 300, priority = {} },
